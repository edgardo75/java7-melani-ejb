                 ...
                 FullTimeEmpleado empfulltime = new FullTimeEmpleado();
                                         ...
                                         if(!empleado.getEmail().isEmpty())
                                                empfulltime.setEmail(empleado.getEmail().toLowerCase());
                                                    ...
                                                    empfulltime.setPassword(ProjectHelpers.ClaveSeguridad.encriptar(StringEscapeUtils.escapeXml10(empleado.getPassword())));                                         empfulltime.setGeneros(em.find(Generos.class, empleado.getIdGenero()));
